...
| 1.1.2.3.17 Members should be able to track their gym progress from the platform. | :large_orange_diamond: | :large_orange_diamond: | :red_circle: |
...
FAILED posts_app/tests.py::LikedPostsViewTestCase::test_liked_posts_success - user_auth_app.models.User.DoesNotExist: User matching query does not exist.
...
## [Planning and Team Process](https://github.com/orgs/bounswe/projects/76/views/4)
...
<details>
<summary>Member: Zeynep Buse Aydın</summary>
...
<pre>
{
	workout_name: "upper body day-1”,
	username: “buse”,
	exercises: [
		{
			equipment: "dumbbell”,
			instruction:  "Seat yourself on an incline bench with a dumbbell in each hand. You should pressed firmly against he back with your feet together. Allow the dumbbells to hang straight down at your side, holding them with a neutral grip. This will be your starting position. Initiate the movement by flexing at the elbow, attempting to keep the upper arm stationary. Continue to the top of the movement and pause, then slowly return to the start position.”,
			muscle:  "biceps”,
...
- [#419](https://github.com/bounswe/bounswe2024group4/issues/419) I implemented the profile page in frontend.
- [#425](https://github.com/bounswe/bounswe2024group4/issues/425) I finalized the exercises components and connected backend, implemented exercise creation functionality in frontend.
- [#438](https://github.com/bounswe/bounswe2024group4/issues/438) I implemented the rating functionality for exercises, couldn’t do meals since it was not ready in backend and we deprioritized.
- [#439](https://github.com/bounswe/bounswe2024group4/issues/439) I implemented follow/unfollow feature in frontend.
- [#440](https://github.com/bounswe/bounswe2024group4/issues/440) I implemented leaderboards (overall, meals and exercises) in frontend.
- [#506](https://github.com/bounswe/bounswe2024group4/issues/506) I worked on fixing the bugs after our first deployment with Kaan.

#### Non-code-related significant issues:
- [#507](https://github.com/bounswe/bounswe2024group4/issues/507) I wrote the testing part in Milestone2 Report with Kaan.

#### Pull requests:
-  [#431](https://github.com/bounswe/bounswe2024group4/pull/431) [#455](https://github.com/bounswe/bounswe2024group4/pull/455) I reviewed and merged Batuhan’s PRs on signup and login frontend implementation.
- [#456](https://github.com/bounswe/bounswe2024group4/pull/456) I implemented the profile page in frontend. Here I struggled a lot since there was a conflict regarding the migration files. At last to solve it, I got the most recent versions from the main branch and did not change anything on those files on my branch.
- [#468](https://github.com/bounswe/bounswe2024group4/pull/468) [#482](https://github.com/bounswe/bounswe2024group4/pull/482) I implemented leaderboards (overall, meals and exercises) in frontend.
- [#470](https://github.com/bounswe/bounswe2024group4/pull/470) [#483](https://github.com/bounswe/bounswe2024group4/pull/483) I implemented follow/unfollow feature in frontend.
- [#471](https://github.com/bounswe/bounswe2024group4/pull/471) I reviewed Kaan’s PR on changing the way we get username from the requests.
- [#476](https://github.com/bounswe/bounswe2024group4/pull/476) I reviewed Batuhan’s PR on the exercise tracking UI in frontend.
- [#477](https://github.com/bounswe/bounswe2024group4/pull/477) I reviewed Kaan’s PR on adding number of repetitions and sets attributes to the exercises.
- [#478](https://github.com/bounswe/bounswe2024group4/pull/478) I finalized the exercises components and connected backend, implemented exercise creation functionality in frontend.
- [#481](https://github.com/bounswe/bounswe2024group4/pull/481) I reviewed Kaan’s PR on fixing a bug in view_profile endpoint.
- [#484](https://github.com/bounswe/bounswe2024group4/pull/484) I implemented exercise program rating feature in frontend.
- [#493](https://github.com/bounswe/bounswe2024group4/pull/493) I wrote frontend unit tests for Leaderboard page loading and ExerciseProgram component.
- [#495](https://github.com/bounswe/bounswe2024group4/pull/495) I enhanced the UI of exercise tracking in frontend.
...
<details>
<summary>Member: Bilge Kaan Güneyli</summary>
...
#### API contributions:
As a backend engineer the most complex I have created in this milestone is `view_profile`. Which gets called when a user clicks profile button or a users username from the leaderboard. The endpoint retrieves the chosen users information and returns them to the frontend, then frontend filters the information based on whether a user is accessing profile of themselves or not. 
...
<pre>
{
    ...
    "bio": "",
    "profile_picture": "media/profile_pictures/kaan.jpg",
    "score": 4.833333333333333,
    "weight_history": [
        {"weight": 92, "date": "2024-11-15T08:30:00Z"},
        {"weight": 98, "date": "2024-11-10T08:30:00Z"}
    ],
    "height": 190.0,
    "following_count": 1,
    "followers_count": 0,
...
#### Code-related significant issues:
- [#420](https://github.com/bounswe/bounswe2024group4/issues/420) Implemented leaderboard, follow and unfollow endpoints
- [#447](https://github.com/bounswe/bounswe2024group4/issues/447) Implemented domain specific sub-leaderboards 
- [#505](https://github.com/bounswe/bounswe2024group4/issues/505) Fixed the issue in authentication
- [#506](https://github.com/bounswe/bounswe2024group4/issues/506) Fixed the issues in POST requests with help from Buse

#### Non-code-related significant issues:
- [#507](https://github.com/bounswe/bounswe2024group4/issues/507) Created Testing part of Milestone Report with Buse

#### Pull requests:
- [#422](https://github.com/bounswe/bounswe2024group4/pull/442) Implemented view and edit profile features and initiated the swagger tool
- [#442](https://github.com/bounswe/bounswe2024group4/pull/442) Implemented leaderboard, follow and unfollow features
- [#461](https://github.com/bounswe/bounswe2024group4/pull/461) Implemented domain specific sub-leaderboards
- [#449](https://github.com/bounswe/bounswe2024group4/pull/449) [#469](https://github.com/bounswe/bounswe2024group4/pull/469) Created swagger schemas and unit tests
- [#464](https://github.com/bounswe/bounswe2024group4/pull/464) [#466](https://github.com/bounswe/bounswe2024group4/pull/466) [#481](https://github.com/bounswe/bounswe2024group4/pull/481) [#486](https://github.com/bounswe/bounswe2024group4/pull/486) [#496](https://github.com/bounswe/bounswe2024group4/pull/496) Small updates or bug fixes
- [#471](https://github.com/bounswe/bounswe2024group4/pull/471) Handled the user authentication problem
- [#477](https://github.com/bounswe/bounswe2024group4/pull/477) Enhanced workouts to include number of sets and reps
- [#479](https://github.com/bounswe/bounswe2024group4/pull/479) Enhanced the directory structure for profile pictures feature
- [#501](https://github.com/bounswe/bounswe2024group4/pull/501) Handled the errors occurred after the deployment
- [#427](https://github.com/bounswe/bounswe2024group4/pull/427) Reviewed Talha's PR for enhancing workouts in backend
- [#428](https://github.com/bounswe/bounswe2024group4/pull/428) Reviewed Can's PR for creating weekly programs in backend
- [#456](https://github.com/bounswe/bounswe2024group4/pull/456) Reviewed Buse's PR for creating profile pages in frontend
- [#459](https://github.com/bounswe/bounswe2024group4/pull/459) Reviewed Can's PR for enhancing workouts and weekly programs in backend
- [#495](https://github.com/bounswe/bounswe2024group4/pull/495) Reviewed Buse's PR for user authentication bug-fix in frontend
...
#### API contributions:
In the backend part, one of the complex Api’s I have created was the ‘create_program’ api. This api makes the user be able to create weekly programs and display it. In order the function to work, proper json file with the ids of workouts and days should be given in the input.
...
{
    "workouts": {
        "1": 9,  // Monday, workout_id 9
        "3": 10,  // Wednesday, workout_id 10
    }
}
    ...
    'days': [
        {
            ...
            'workout': {
                'id': 9,
                'name': ‘Full ‘Body Workout by Mcan
            }
        },
        {
            'day': 'Wednesday',
...
#### Code-related significant issues:
- [#441](https://github.com/bounswe/bounswe2024group4/issues/441) Create weekly program api
- [#442](https://github.com/bounswe/bounswe2024group4/issues/442) Implement tracking down workouts inside weekly programs
- [#508](https://github.com/bounswe/bounswe2024group4/issues/508) Implement (un)bookmarking of workouts

#### Non-code-related significant issues:
- [#510](https://github.com/bounswe/bounswe2024group4/issues/510) Decided on the Activity Stream storage and categorization of the project

#### Pull requests:
- [#494](https://github.com/bounswe/bounswe2024group4/pull/494)*bookmarking added: workouts/toggle-bookmark/
seeing bookmarked workouts added: get-bookmarked-workouts/
*workout deletion added: 'workouts/delete/int:workout_id/'
*minor improvements on workout logs, get workout programs by username and get workout logs of the user
*Get methods contain url params now
*Code urls part refactored for a more proper view
- [#459](https://github.com/bounswe/bounswe2024group4/pull/459) Minor changes made inside workout_program, rate_workout, get_workout_by_id.
get_programs_by_user_id added for getting the weekly programs the spesific user created
workout_log added for being able to mark a spesific workout and its exercises as "done" or "undone" with date date providing, making able to
get_workout_logs_by_user added to get spesific users logs to use in the streak
*unnecessary functions from profile app deleted
- [#428](https://github.com/bounswe/bounswe2024group4/pull/428) *weekly program addition
*day-workout log addition
*weekly programs and day-workout logs of the authenticated user
- [#477](https://github.com/bounswe/bounswe2024group4/pull/477) Reviewed Kaan’s work on enhancing workouts to include number of sets and reps
- [#427](https://github.com/bounswe/bounswe2024group4/pull/427) Reviewed Talha's PR for enhancing workouts in backend
...
<details>
<summary>Member: Nurullah Uçan</summary>
...
#### Code-related significant issues:
- [#414](https://github.com/bounswe/bounswe2024group4/issues/414) Implement UI for login and signup pages in mobile
- [#446](https://github.com/bounswe/bounswe2024group4/issues/446) Implement Profile Page for Mobile
- [#453](https://github.com/bounswe/bounswe2024group4/issues/453) Enhance Login and Signup Screens with Usability Improvements in Mobile
- [#462](https://github.com/bounswe/bounswe2024group4/issues/462) Implement and Enhance Edit Profile Page in Mobile
- [#497](https://github.com/bounswe/bounswe2024group4/issues/497) Add unit tests for EditProfileScreen component to mobile

#### Non-code-related significant issues:
- [#511](https://github.com/bounswe/bounswe2024group4/issues/511) Updates to Roadmap for Milestone Report

#### Pull requests:
-  [#454](https://github.com/bounswe/bounswe2024group4/pull/454)  N.ucan/login signup UI
- [#492](https://github.com/bounswe/bounswe2024group4/pull/492) N.ucan/profile page
- [#475](https://github.com/bounswe/bounswe2024group4/pull/475) Adding leaderboard screen to mobile (Reviewed)
- [#473](https://github.com/bounswe/bounswe2024group4/pull/473) Fixed signup login navigation (Reviewed)
- [#429](https://github.com/bounswe/bounswe2024group4/pull/429) Fix edit workout (Reviewed)
...
<details>
<summary>Member: Ahmet Batuhan Canlı</summary>
...
ExerciseProgramList.js:28
• Object
config: {transitional: {silentJSONParsing: true, forcedJSONParsing: true, clarifyTimeoutError: false}, adapter: ["xhr", "http", "fetch"], transformRequest: Array, transformResponse: Array, timeout: 0, ...} data: [Object, Object,
Object, Object, Object,
Objectl (6)
headers: AxiosHeaders {content-length:
"11188",
content-type: "application/json"}
request: XMLHttpRequest {listeners: Object, onreadystatechange: null, readyState: 4, timeout: 0, withCredentials: true, ..
status: 200
statusText: "OK"
• Object Prototype
</pre>
...
#### Code-related significant issues:
- [#430](https://github.com/bounswe/bounswe2024group4/issues/430) Creating login and signup page
- [#435](https://github.com/bounswe/bounswe2024group4/issues/435) connecting signup and login pages with the backend
- [#475](https://github.com/bounswe/bounswe2024group4/issues/474) implementing exercise tracking mechanism



#### Pull requests:
Pull requests that I created and merged:
- [#431]( https://github.com/bounswe/bounswe2024group4/pull/431) login and signup page ui
- [#455]( https://github.com/bounswe/bounswe2024group4/pull/455) connecting them with the backend
- [#476]( https://github.com/bounswe/bounswe2024group4/pull/476) exercise tracking ui – It has a little conflict that I solved. I removed 1 paranthesis and conflict is solved.
- [#485]( https://github.com/bounswe/bounswe2024group4/pull/485) connecting with backend
- [#487]( https://github.com/bounswe/bounswe2024group4/pull/487) connection finalized.

Pull requests that I reviewed:
- [#456](https://github.com/bounswe/bounswe2024group4/pull/456) profile page by Buse
- [#468](https://github.com/bounswe/bounswe2024group4/pull/468) leaderboard by Buse
- [#470](https://github.com/bounswe/bounswe2024group4/pull/470) auth bug fix by Buse
- [#478](https://github.com/bounswe/bounswe2024group4/pull/478) exercises by Buse
...
<details>
<summary>Member: Talha Ordukaya</summary>
...
#### API contributions:
One of the APIs I implemented was the create_post endpoint, which allows users to create posts and optionally link them to a workout or meal. This endpoint enhances the platform’s engagement features by enabling users to share their progress or experiences.

##### Endpoint: 
<pre>
{
	"content": "Just completed an intense upper body workout!",
	"workoutId": 15,
	"mealId": 8
}
</pre>
...
#### Code-related significant issues:
- [#426](https://github.com/bounswe/bounswe2024group4/issues/426): Implemented endpoints for managing workouts, including rating workouts, retrieving a specific workout by its ID, and fetching workouts associated with a specific user ID.
- [#443](https://github.com/bounswe/bounswe2024group4/issues/443): Developed the home feed and following feed functionalities, enabling users to view posts and activities from all users or just the ones they follow.
- [#444](https://github.com/bounswe/bounswe2024group4/issues/444): Implemented post functionalities, such as creating posts, liking/unliking posts, commenting on posts, and bookmarking posts, to enhance user engagement.
- [#445](https://github.com/bounswe/bounswe2024group4/issues/445): Wrote unit tests for critical backend features, including user authentication (login, signup, logout) and workout-related operations, ensuring reliability and code quality.

#### Pull requests:
- [#427](https://github.com/bounswe/bounswe2024group4/pull/427): Implemented endpoints for managing workouts, including rating workouts, retrieving a specific workout by its ID, and fetching user-specific workouts.
- [#448](https://github.com/bounswe/bounswe2024group4/pull/448): Added Swagger documentation for workout endpoints and updated user information in models.
- [#451](https://github.com/bounswe/bounswe2024group4/pull/451): Implemented post functionalities, including creating, liking, commenting, and bookmarking posts.
- [#452](https://github.com/bounswe/bounswe2024group4/pull/452): Developed the feed and following feed functionalities, enabling users to view posts and interactions from all users or just their followings.
- [#463](https://github.com/bounswe/bounswe2024group4/pull/463): Added endpoints for managing token and session functionalities, improving user authentication and session handling.
- [#465](https://github.com/bounswe/bounswe2024group4/pull/465): Updated terminology in posts, replacing references to “exercise” with “workout” to ensure consistency across the platform.
- [#467](https://github.com/bounswe/bounswe2024group4/pull/467): Wrote unit tests for critical endpoints, ensuring reliability and maintainability of the implemented features.
- [#472](https://github.com/bounswe/bounswe2024group4/pull/472): Enhanced Swagger documentation, updated existing endpoints, and resolved bugs for a smoother development experience.

</details>

<details>
<summary>Member: Berat Yılmaz </summary>
...
#### Code-related significant issues:
- [#432](https://github.com/bounswe/bounswe2024group4/issues/432) Fix navigation of the signup / login page
- [#433](https://github.com/bounswe/bounswe2024group4/issues/433) Connect exercise page of mobile to backend

#### Pull requests:
-  [#473](https://github.com/bounswe/bounswe2024group4/pull/473)  I fixed the navigation for signup and login pages.
- [#489](https://github.com/bounswe/bounswe2024group4/pull/489) I connected the exercise tab to backend to display the workouts created by the user.
- [#491](https://github.com/bounswe/bounswe2024group4/pull/491) I added unit tests for the home page that redirects to signup and login pages.
- [#475](https://github.com/bounswe/bounswe2024group4/pull/480) Adding leaderboard screen to mobile (Reviewed)
- [#480](https://github.com/bounswe/bounswe2024group4/pull/480) baseURL for mobile (Reviewed)
- [#488](https://github.com/bounswe/bounswe2024group4/pull/488) Signup and login for mobile (Reviewed)

</details>

<details>
<summary>Member: Ceyhun Sonyürek</summary>
...
#### Main contributions:
Between Customer Milestone 1 and Customer Milestone 2, my main contributions were centered around enhancing the mobile application by adding new features, resolving bugs, improving existing functionalities, and reviewing my teammates’ work to provide feedback.
...
#### Code-related significant issues:
- [#450](https://github.com/bounswe/bounswe2024group4/issues/450)
- [#498](https://github.com/bounswe/bounswe2024group4/issues/498)
- [#499](https://github.com/bounswe/bounswe2024group4/issues/499)
- [#503](https://github.com/bounswe/bounswe2024group4/issues/503)

#### Non-code-related significant issues:
- [#513](https://github.com/bounswe/bounswe2024group4/issues/513)

#### Pull requests:
- [#429](https://github.com/bounswe/bounswe2024group4/pull/429) I fixed a bug which crushes app while editing a workout.
- [#475](https://github.com/bounswe/bounswe2024group4/pull/475) I added leaderboard UI design for mobile.
- [#480](https://github.com/bounswe/bounswe2024group4/pull/480) I changed to backend calls to a more simple form.
- [#488](https://github.com/bounswe/bounswe2024group4/pull/488) I added to signup and login functionalities.
- [#491](https://github.com/bounswe/bounswe2024group4/pull/491) I added test for leaderboard screen.
- [#502](https://github.com/bounswe/bounswe2024group4/pull/502) I connected to profile page backend and made it callable from the leaderboard screen.
- [#454](https://github.com/bounswe/bounswe2024group4/pull/454) Reviewed
- [#473](https://github.com/bounswe/bounswe2024group4/pull/473) Reviewed
- [#489](https://github.com/bounswe/bounswe2024group4/pull/489) Reviewed
- [#490](https://github.com/bounswe/bounswe2024group4/pull/490) Reviewed
- [#492](https://github.com/bounswe/bounswe2024group4/pull/492) Reviewed
