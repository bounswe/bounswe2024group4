    ...
    <div className= "bg-nba min-h-screen bg-top-left">
        ...
        <main className="container mx-auto mt-40">
          <div className="signin-form">
            ...
            <h1 className="text-3xl font-bold text-blue-500 mb-4">Welcome to NBA Forum!</h1>
              ...
              <input type="password" name="password" placeholder="Password" required className="border p-2 rounded-md mb-8 w-full" onChange={handleChange} />
              { formErrorMessage !== '' && <p className="text-red-500 mb-4">{formErrorMessage}</p>}
              <div className="flex justify-center flex-col items-center">
                    <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold w-full px-4 py-2 rounded-md mb-2">Sign in</button>
                    <hr className="border-gray-100 w-full my-2" />
                    <button type="button" className="bg-nba-pink hover:bg-nba-pink-darker text-white font-bold w-full px-4 py-2 rounded-md mt-2" onClick = {handleCreateAccount}>Create a new account</button>
                </div>
            </form>
          </div>
        </main>
