    ...
    <header className="bg-white py-2 border border-slate-150">
      <nav className="container mx-auto flex justify-between items-center">
        <div className="flex justify-between">
          ...
          <div className="logo flex ml-4 items-center" onClick={handleLogo}>
        ...
        <div className="flex justify-between">
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded-md mr-4" onClick={handleCreatePost} >Create a Post</button>
          <div>
